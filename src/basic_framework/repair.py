...
from .block import *
from .cfs import *
from .core_testing import Tester
from .statement import *
from .hole_injection import *
from .template import *
from .refactoring_ast import astRefactor
...
class BlockRepair:
    def __init__(self, ques_dir_path, exp_time=5):
        self.__ques_dir_path = ques_dir_path
        self.__exp_time = exp_time
    ...
    def __get_trace_map(self, bug_code, func_name):
        ...
        for tc_id in tc_id_list:
            ...
            Holes.vari_hist = {}
            self.__tester.run_tc(bug_hole_code, tc_id, timeout=10)
    ...
    def get_closest_rc(self, bug_code, refactoredCodes):
        ...
        debug_flag = False
        if debug_flag:
            from .refactoring import Reporter
