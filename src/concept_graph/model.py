...
class Block(object):
    ...
    __slots__ = ["id", "statements", "func_calls", "predecessors", "exits", "concepts"]
    ...
    def get_source(self):
        ...
        for statement in self.statements:
            ...
            elif type(statement) == ast.AsyncFunctionDef:#type(statement) == ast.FunctionDef or\
...
class CFG(object):
    ...
    def _visit_blocks(self, graph, block, visited=[], calls=True, isEntry=False):
    ...
    def _build_visual(self, format='pdf', calls=True):
        ...
        self._visit_blocks(graph, self.entryblock, visited=[], calls=calls, isEntry=True)
